...
exports.EspecialidadesModule = EspecialidadesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([especialidade_entity_1.Especialidad])],
        controllers: [especialidades_controller_1.EspecialidadController],
        providers: [especialidades_service_1.EspecialidadService],
    })
